...
import produit1 from '../medical/11.jpg';
import produit2 from '../medical/22.jpg';
import produit3 from '../medical/33.jpg';
import produit4 from '../medical/44.jpg';
import produit5 from '../medical/55.jpg';
import produit6 from '../medical/66.jpg';
...
const Appareils = () => {
  ...
  const titles = [
    'Appareils de Mesure - 6 Produits',
    'Équipement de Diagnostic',
    'Découvrez notre Gamme Médicale'
  ];
  ...
  const products = [
    {
      ...
      price: "89,900",
      image: produit1,
      description: 'Tensiomètre automatique de précision',
      type: 'Tension',
      marque: 'Omron',
      prix: 'plus-50'
    },
    {
      ...
      price: "65,500", 
      image: produit2,
      description: 'Lecteur de glycémie avec bandelettes',
      type: 'Glycémie',
      marque: 'Accu-Chek',
      prix: 'plus-30'
    },
    ...
    },
    {
      ...
      price: "35,900",
      image: produit4,
      description: 'Mesure la saturation en oxygène',
      type: 'Oxygène',
      marque: 'Nonin',
      prix: 'plus-30'
    },
    {
      name: 'Balance Impédancemètre',
      price: "120,900",
      image: produit5,
      description: 'Balance connectée avec analyse corporelle',
      type: 'Poids',
      marque: 'Withings',
      prix: 'plus-50'
    },
    ...
    <div className="soin-homme-container" style={{ backgroundColor: colorTheme }}>
      ...
      <div className="filters-section">
        <div className="filter-group">
          ...
          {['Tension', 'Glycémie', 'Température', 'Oxygène', 'Poids', 'Auscultation'].map(type => (
            <label key={type}>
              <input
                type="checkbox"
        ...
        <div className="filter-group">
          <h3>Marque</h3>
          {['Omron', 'Accu-Chek', 'Braun', 'Nonin', 'Withings', 'Littmann'].map(marque => (
            <label key={marque}>
              <input
                type="checkbox"
