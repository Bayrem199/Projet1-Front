...
import produit1 from '../Femme/7.jpg';
import produit2 from '../Femme/8.jpg';
import produit3 from '../Femme/9.jpg'; 
import produit4 from '../Femme/10.jpg';
import produit5 from '../Femme/11.jpg';
import produit6 from '../Femme/12.jpg';
...
const MakeupF = () => {
  ...
  const titles = [
    'Maquillage - 6 Produits',
    'Produits de Beauté',
    'Découvrez notre Gamme Maquillage'
  ];
  ...
  const products = [
    ...
    },
    {
      ...
      price: "35,900",
      image: produit5,
      description: 'Blush poudre naturel',
      type: 'Teint',
      marque: 'NARS',
      prix: 'plus-30'
    },
    {
      ...
      price: "42,500",
      image: produit6,
      description: 'Illuminateur poudre',
      type: 'Teint',
      marque: 'Fenty Beauty',
      prix: 'plus-30'
    }
  ...
  return (
    <div className="soin-homme-container" style={{ backgroundColor: colorTheme }}>
      ...
      <div className="filters-section">
        ...
        <div className="filter-group">
          <h3>Marque</h3>
          {['MAC', 'Dior', 'Lancôme', 'Urban Decay', 'NARS', 'Fenty Beauty'].map(marque => (
            <label key={marque}>
              <input
                type="checkbox"
