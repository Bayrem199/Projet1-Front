...
import produit1 from '../Homme/7.webp';
import produit2 from '../Homme/8.jpg'; 
import produit3 from '../Homme/9.jpg';
import produit4 from '../Homme/10.jpg';
import produit5 from '../Homme/11.jpg';
import produit6 from '../Homme/12.jpg';
...
const SoincorpsH = () => {
  ...
  const titles = [
    'Soins Corps Homme - 6 Produits',
    'Produits Corps pour Homme',
  ...
  const products = [
    ...
    {
      name: 'Crème Corps DS Pharma',
      price: "85,000", 
      image: produit2,
      description: 'Crème hydratante corps',
      type: 'Crème',
      marque: 'DS Pharma',
      prix: 'plus-50'
    },
    {
      name: 'Huile Corps Ducray',
      price: "45,500",
      image: produit3, 
      description: 'Huile nourrissante corps',
      type: 'Huile',
      marque: 'Ducray',
      prix: 'plus-30'
    },
    {
      name: 'Lait Corps FLOXIA',
      price: "52,900",
      image: produit4,
      description: 'Lait hydratant corps',
      type: 'Lait',
      marque: 'FLOXIA', 
      prix: 'plus-50'
    },
    {
      name: 'Gommage Corps Hyfac',
      price: "27,900",
      image: produit5,
      description: 'Gommage exfoliant corps',
      type: 'Gommage',
      marque: 'Hyfac',
      prix: 'moins-30'
    },
    {
      name: 'Baume Corps Titania',
      price: "67,500",
      image: produit6,
      description: 'Baume nourrissant corps',
      type: 'Baume',
      marque: 'Titania',
      prix: 'plus-50'
    }
    ...
    <div className="soin-homme-container" style={{ backgroundColor: colorTheme }}>
      ...
      <div className="filters-section">
        <div className="filter-group">
          ...
          {['Douche', 'Crème', 'Huile', 'Lait', 'Gommage', 'Baume'].map(type => (
            <label key={type}>
              <input
                type="checkbox"
